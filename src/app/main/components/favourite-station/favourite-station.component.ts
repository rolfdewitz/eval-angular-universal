...
export class FavouriteStationComponent implements OnInit {
  ...
  @Select(AppState.favouredNetworkStation) favouredNetworkStation$: Observable<any>;

  constructor(private store: Store) {}

  ngOnInit(): void {
    this.store.dispatch(new GetFavouriteNetworkStation({
      networkId: 'onroll-el-campello', stationId: '2c1070f972885eff8b3df5db356dc10e' }));
  }
